...
#SBATCH --job-name cifti_clean_ImObs_6mm
#SBATCH --cpus-per-task=2
#SBATCH --output=/projects/loliver/SPINS_ASD_ImObs_GLM/data/outputs_2023/SPINS/logs/cifti_clean_ImObs_6mm.txt
#SBATCH --error=/projects/loliver/SPINS_ASD_ImObs_GLM/data/outputs_2023/SPINS/logs/cifti_clean_ImObs_6mm.err
#SBATCH --array=1-438
...
# cifti clean ImObs data, including 6 mm smoothing and dropping 4 TRs (no actual cleaning)
