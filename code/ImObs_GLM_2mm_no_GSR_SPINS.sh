...
#SBATCH --export=ALL
#SBATCH --job-name="ImObs_GLM_2mm_no_GSR_SPINS"
#SBATCH --output=/projects/loliver/SPINS_ASD_ImObs_GLM/data/outputs_2023/SPINS/logs/ImObs_GLM_2mm_no_GSR_SPINS.txt
...
sub_out=/projects/loliver/SPINS_ASD_ImObs_GLM/data/outputs_2023/SPINS/sub-`index`/2_mm_no_GSR

if [ ! -f ${sub_out}/*task-imobs_1stlevel.dscalar.nii ]; then
   python3 /projects/loliver/SPINS_ASD_ImObs_GLM/code/ImObs_GLM_2mm_no_GSR_SPINS.py ${sub_in} ${reg_in} ${sub_out} `index`
fi
