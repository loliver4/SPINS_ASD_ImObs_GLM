...
file_handler = logging.FileHandler(
    "/projects/loliver/SPINS_ASD_ImObs_GLM/data/outputs_2023/3dDeconvolve.log"
)
...
def main():
    ...
    for f in os.listdir(in_path):
        if "task-imi_run-1_desc-preproc_Atlas_s6.dtseries.nii" in f:
    ...
    #    "sub-"
    #    + sub_id
    #    + "task-obs_run-1_desc-preproc_Atlas_s6.dtseries.nii",
    # )
